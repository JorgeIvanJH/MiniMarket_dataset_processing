...
def generate_hdf5_dataset_with_padding(path_, hdf5_filename, desired_number_of_sample_points):

	# Get files
	print("path_: ",path_)
	pcds = sorted(glob.glob(os.path.join(path_, "*.pcd")))
	print( "files",pcds )
...
# #10 KETCHUP
# EAN_code= ""
# EAN_product_name= "ketchup_heinz_400ml"
